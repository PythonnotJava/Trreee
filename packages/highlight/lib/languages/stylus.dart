...
/// Highlight.js language definition for `stylus`.
Mode stylus(Highlight hljs) {
  ...
  mode6.begin = r'#(([0-9a-fA-F]{3,4})|(([0-9a-fA-F]{2}){3,4}))\b';
  mode7.scope = r'number';
  mode7.begin =
      r'\b\d+(\.\d+)?(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?';
  mode7.relevance = 0;
  mode8.scope = r'variable';
  mode8.begin = r'\$[a-zA-Z]\w*';
  mode9.scope = r'built_in';
  mode9.begin = r'[\w-]+(?=\()';
  return Mode(
    name: r'Stylus',
    aliases: [r'styl'],
    caseInsensitive: false,
    keywords: r'if else for in',
    illegal:
        r'(\?|(\bReturn\b)|(\bEnd\b)|(\bend\b)|(\bdef\b)|;|#\s|\*\s|===\s|\||%)',
    contains: [
      mode0,
      mode2,
      Mode(
      ...
      mode6,
      Mode(
        begin: r'\.[a-zA-Z][a-zA-Z0-9_-]*(?=[.\s\n[:,(])',
        scope: r'selector-class',
      ),
      Mode(
        begin: r'#[a-zA-Z][a-zA-Z0-9_-]*(?=[.\s\n[:,(])',
        scope: r'selector-id',
      ...
      Mode(
        ...
        scope: r'selector-tag',
      ),
      Mode(
        scope: r'selector-pseudo',
        begin:
      ...
      Mode(
        scope: r'selector-pseudo',
        begin:
            r'&?:(:)?(spelling-error|slotted|selection|placeholder|part|marker|grammar-error|first-line|first-letter|cue-region|cue|before|backdrop|after)(?=[.\s\n[:,(])',
      ),
      Mode(
        scope: r'selector-attr',
        begin: r'\[',
        end: r'\]',
        illegal: r'$',
        contains: [mode2, mode0],
      ),
      Mode(
        scope: r'keyword',
        begin: r'@media',
      ...
      Mode(
        scope: r'keyword',
        begin:
            r'@((-(o|moz|ms|webkit)-)?(charset|css|debug|extend|font-face|for|import|include|keyframes|media|mixin|page|warn|while))\b',
      ),
      mode8,
      mode7,
      Mode(
        ...
        returnBegin: true,
        contains: [
          Mode(scope: r'title', begin: r'\b[a-zA-Z][a-zA-Z0-9_-]*'),
          Mode(
            scope: r'params',
            begin: r'\(',
            end: r'\)',
            contains: [mode6, mode8, mode2, mode7, mode0],
          ),
        ],
      ),
      Mode(scope: r'attr', begin: r'--[A-Za-z_][A-Za-z0-9_-]*'),
      Mode(
        scope: r'attribute',
        begin:
        ...
        starts: Mode(
          ...
          contains: [
            ...
            mode7,
            mode3,
            Mode(scope: r'meta', begin: r'!important'),
            mode9,
          ],
          illegal: r'\.',
          relevance: 0,
