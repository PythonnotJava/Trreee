...
Mode typescript(Highlight hljs) {
  ...
  _mode37.scope = r'meta';
  _mode37.begin = r'@[A-Za-z$_][0-9A-Za-z$_]*';
  _mode38.relevance = 0;
  _mode38.match =
      r'(?:\bJSON|\b[A-Z][a-z]+([A-Z][a-z]*|\d)*|\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*|\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*)';
  _mode38.scope = r'title.class';
  _mode38.keywords = {
    r'_': [
      r'Object',
      r'Function',
  ...
  _mode39.scope = r'attr';
  _mode39.match = r'[A-Za-z$_][0-9A-Za-z$_]*(?=:)';
  _mode39.relevance = 0;
  _mode40.scope = r'attr';
  _mode40.match = r'[A-Za-z$_][0-9A-Za-z$_]*(?=\s*\?:)';
  _mode40.relevance = 0;
  _mode41.scope = r'params';
  _mode41.begin = r'(\s*)\(';
  _mode41.end = r'\)';
  _mode41.excludeBegin = true;
  _mode41.excludeEnd = true;
  _mode41.keywords = {
    r'$pattern': r'[A-Za-z$_][0-9A-Za-z$_]*',
    r'keyword': [
      r'as',
  ...
  _mode41.contains = [
    ...
    _mode36,
    _mode37,
    [_mode38, _mode39, _mode40],
  ];
  return Mode(
    name: r'TypeScript',
    aliases: [r'ts', r'tsx', r'mts', r'cts'],
    keywords: {
      r'$pattern': r'[A-Za-z$_][0-9A-Za-z$_]*',
      r'keyword': [
        r'as',
    ...
    exports: {
      ...
      r'CLASS_REFERENCE': _mode38,
    },
    illegal: r'#(?![$_A-z])',
    contains: [
      Mode(scope: r'meta', begin: r'^#![ ]*\/', end: r'$', relevance: 0),
      Mode(scope: r'meta', relevance: 10, begin: '^\\s*[\'"]use strict[\'"]'),
      _mode15,
      _mode17,
      _mode18,
      _mode21,
      ...
      _mode37,
      Mode(
        begin: [r'namespace', r'\s+', r'[a-zA-Z]\w*'],
        beginScope: {1: r'keyword', 3: r'title.class'},
      ),
      Mode(
        beginKeywords: r'interface',
        end: r'\{',
        excludeEnd: true,
        keywords: {
          r'keyword': r'interface extends',
          r'built_in': [
            r'any',
            r'void',
            r'number',
